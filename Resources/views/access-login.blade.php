                        ...
                        <div class="text-center shadow-xl rounded-md bg-white sm:mr-2 m-1 pt-3 p-2 ">
                            ...
                            <div class="bg-white mb-3 text-left">
                                <div class="my-3 md:flex md:items-center">
                                    ...
                                    <div class="md:w-2/3">
                                        <input
                                            class="shadow appearance-none border rounded w-full py-2 px-1 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-80"
                                            id="username" name="username" type="tel" placeholder="Username" required>
